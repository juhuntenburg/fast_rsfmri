...
from functions import strip_rois_func, motion_regressors, median, make_regress, selectindex
...
# directories
working_dir = '/home/julia/projects/fast_rsfmri/working_dir/'
data_dir= "/home/julia/projects/fast_rsfmri/%s/processed/%s"%(dataset, scan)
data_dir= "/home/julia/projects/fast_rsfmri/%s/processed/%s"%(dataset, scan)
...
moco = Node(fsl.MCFLIRT(),name="moco")
preproc_func.connect([(apply_func, moco, [('out_file', 'in_file')])])
...
# preproc_func.connect([(moco, func_sink, [('par_file', 'confounds.@orig_motion')]),
